#!/usr/bin/env python3
"""
Auto-update CLAUDE.md (raiz) + 3 satélites a partir de profiles.json + prodam.db.
...
def generate_claude_md(m):
    ...
    L.append("```powershell")
    L.append("py -3.12 scripts\\auto_update_claude_md.py          # regenera CLAUDE.md + 3 satélites")
