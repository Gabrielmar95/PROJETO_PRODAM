...
_Atualizado em 26/05/2026 13:14 via `scripts/auto_update_claude_md.py`._
...
- 🟠 **SSP**: 2026-06-30 (35 dias) — R$ 4.553.230,80
...
```powershell
py -3.12 scripts\auto_update_claude_md.py          # regenera CLAUDE.md + 3 satélites
