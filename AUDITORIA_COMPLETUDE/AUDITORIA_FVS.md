...
**Fundação de Vigilância em Saúde** | Categoria: **GOV_INDIRETA** | Data: 2026-06-09
...
| Contratos SPCF | 0 | — |
| Contratos no DB | 0 | — |
| Empenhos no DB | 517 | R$ 7.501.889,40 |
| Faturas no DB | 1 | R$ 14.638,55 |
| Cobranças SPCF | 1 | — |
...
| Recurso | Caminho |
|---------|---------|
| Pasta Dossiê | /sessions/wizardly-affectionate-babbage/mnt/PROJETO_PRODAM/PRODAM_DOCS/FVS_DOSSIE |
| Pasta Consolidado | /sessions/wizardly-affectionate-babbage/mnt/PROJETO_PRODAM/PRODAM_DOCS/FVS_CONSOLIDADO |
| SPCF por_devedor | /sessions/wizardly-affectionate-babbage/mnt/PROJETO_PRODAM/SPCF_EXTRACAO/por_devedor/FVS |
